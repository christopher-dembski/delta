...
// public class OldStatisticsService implements IMealStatisticsService {
//     @Override
//     public OldNutrientStatistics calculateNutrientBreakdown(List<meals.models.meal.Meal> meals) {
...
//         return new OldNutrientStatistics(nutrientPercentages, nutrientTotals, totalCalories, meals.size());
//     }
