 ...
 */
public class FoodGroupV2 implements IRecord {
     ...
     */
    public FoodGroupV2(Integer foodGroupId, Integer foodGroupCode, String foodGroupName, String foodGroupNameF) {
    ...
    /**
     * Constructor for creating a FoodGroupV2 from database record data.
     */
    public FoodGroupV2(IRecord record) {
    ...
    public String toString() {
        return "FoodGroupV2(id: %d, name: %s)".formatted(foodGroupId, foodGroupName);
    }
    ...
    public boolean equals(Object obj) {
        ...
        FoodGroupV2 that = (FoodGroupV2) obj;
