 ...
 */
public class NutrientV2 implements IRecord {
     ...
     */
    public NutrientV2(Integer nutrientId, Integer nutrientCode, String nutrientSymbol, String nutrientUnit,
    ...
    /**
     * Constructor for creating a NutrientV2 from database record data.
     */
    public NutrientV2(IRecord record) {
    ...
    public String toString() {
        return "NutrientV2(id: %d, name: %s, unit: %s)".formatted(nutrientId, nutrientName, nutrientUnit);
    }
    ...
    public boolean equals(Object obj) {
        ...
        NutrientV2 that = (NutrientV2) obj;
